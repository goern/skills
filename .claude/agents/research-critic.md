...
**Reviewer:** research-critic teammate
**Target:** <file>
...
- If `research-skeptic` is in the team, coordinate via mailbox — they handle source quality, you handle logical structure. Don't duplicate.
